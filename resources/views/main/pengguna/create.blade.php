        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control telp" name="telp" id="telp" placeholder="masukkan telp">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control upt" name="upt" id="upt" placeholder="masukkan upt">
