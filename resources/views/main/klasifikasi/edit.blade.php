<div class="col-12">
    <form id="formEdit">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <input type="hidden" name="id" id="id" value="{{$klasifikasi->id}}">
                <div class="card-body">
                    <div class="form-group">
                        <label for="klasifikasi">Nama Klasifikasi</label>
                        <input type="text" class="form-control klasifikasi" name="klasifikasi" value="{{$klasifikasi->klasifikasi}}" id="klasifikasi" placeholder="masukkan nama klasifikasi">
                        <div class="invalid-feedback error-klasifikasi"></div>
                    </div>
                    <div class="form-group">
                        <label for="nomor">Nomor Klasifikasi</label>
                        <input type="text" class="form-control nomor" name="nomor" id="nomor" value="{{$klasifikasi->nomor}}" placeholder="masukkan nomor klasifikasi">
