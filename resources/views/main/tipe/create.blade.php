        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control tipe" name="tipe" id="tipe" placeholder="masukkan nama tipe surat">
                    <div class="invalid-feedback error-tipe"></div>
                </div>
                <div class="form-group">
                    <label for="nomor">Nomor Tipe Surat</label>
                    <input type="text" class="form-control nomor" name="nomor" id="nomor" placeholder="masukkan nomor tipe surat">
